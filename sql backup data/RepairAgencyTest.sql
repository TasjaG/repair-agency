...
-- #3 Repair Agency System - by Anastasiia Hryhorieva
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `repair_agency_test` ;
USE `repair_agency_test` ;

-- -----------------------------------------------------
-- Table `repair_agency_test`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `repair_agency_test`.`users` ;

CREATE TABLE IF NOT EXISTS `repair_agency_test`.`users` (
...
-- -----------------------------------------------------
-- Table `repair_agency_test`.`applications`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `repair_agency_test`.`applications` ;

CREATE TABLE IF NOT EXISTS `repair_agency_test`.`applications` (
  ...
  CONSTRAINT `fk_applications_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `repair_agency_test`.`users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `repair_agency_test`.`accepted_applications`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `repair_agency_test`.`accepted_applications` ;

CREATE TABLE IF NOT EXISTS `repair_agency_test`.`accepted_applications` (
  `aa_id` INT NOT NULL AUTO_INCREMENT,
  `aa_product_name` VARCHAR(75) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  `aa_product_comment` VARCHAR(200) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL,
  ...
  CONSTRAINT `fk_accepted_applications_applications1`
    ...
    REFERENCES `repair_agency_test`.`applications` (`application_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `repair_agency_test`.`comments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `repair_agency_test`.`comments` ;

CREATE TABLE IF NOT EXISTS `repair_agency_test`.`comments` (
...
-- -----------------------------------------------------
-- Table `repair_agency_test`.`user_types`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `repair_agency_test`.`user_types` ;

CREATE TABLE IF NOT EXISTS `repair_agency_test`.`user_types` (
...
-- -----------------------------------------------------
-- Table `repair_agency_test`.`users_and_types`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `repair_agency_test`.`users_and_types` ;

CREATE TABLE IF NOT EXISTS `repair_agency_test`.`users_and_types` (
  ...
  CONSTRAINT `fk_user_types_has_users_user_types1`
    ...
    REFERENCES `repair_agency_test`.`user_types` (`utype_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
