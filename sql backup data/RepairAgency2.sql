...
-- -----------------------------------------------------
-- Table `repair_agency`.`user_and_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `repair_agency`.`user_and_type` ;

CREATE TABLE IF NOT EXISTS `repair_agency`.`user_and_type` (
